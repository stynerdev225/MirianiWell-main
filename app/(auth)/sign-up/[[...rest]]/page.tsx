    ...
    <SignUp
      appearance={{
        elements: {
          ...
          formInputLabel:
            "font-medium text-gray-700 mb-2 text-sm text-center w-full block",
          ...
          formFieldLabel__identifier:
            "text-lg font-semibold text-center mb-3 block w-full mx-auto text-gray-800",
          formFieldLabelRow: "flex justify-center items-center",
          formFieldAction__identifier: "text-center mx-auto",
          footer: "mt-6",
