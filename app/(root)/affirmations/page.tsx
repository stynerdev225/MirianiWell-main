...
const AffirmationsPage = async () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-orange-50 px-4 py-6 sm:p-6">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="text-center mb-6 sm:mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-white rounded-full shadow-sm mb-3 sm:mb-4">
          ...
          <div className="bg-gradient-to-r from-pink-500 to-orange-500 rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8 mb-6 sm:mb-8 text-white text-center">
            ...
            <blockquote className="text-xl sm:text-2xl font-medium mb-4 sm:mb-6 italic">
              &ldquo;I am worthy of love, healing, and all the magic life has to
              offer.&rdquo;
            </blockquote>
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
              <button className="flex items-center justify-center gap-2 px-4 py-2 sm:px-6 sm:py-3 bg-white/20 rounded-lg hover:bg-white/30 transition-colors">
              ...
              (category: {
                ...
                >
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <div
                      className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-[${category.color}]`}
                    />
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    {category.affirmations.map(
                      (affirmation: string, index: number) => (
                        <div
                          key={index}
                          className="p-3 sm:p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow group cursor-pointer"
                        >
                          <p className="text-sm sm:text-base text-gray-700 mb-2 italic">
                  ...
                  <button className="w-full mt-4 py-2 border-2 border-dashed border-gray-300 text-gray-500 rounded-lg hover:border-gray-400 hover:text-gray-600 transition-colors text-sm sm:text-base">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8">
            <div className="text-center mb-5 sm:mb-6">
              ...
              <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto mb-5 sm:mb-6">
                Take 5-10 minutes to center yourself with a guided affirmation
                session
              </p>
            </div>

            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg sm:rounded-xl p-5 sm:p-8 text-center">
              <div className="mb-5 sm:mb-6">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <Play className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                </div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">
                  Self-Love Practice
                </h3>
                <p className="text-sm text-gray-600">5 minutes • Beginner friendly</p>
              </div>

              <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-5 sm:mb-6">
                <button className="px-6 py-2.5 sm:px-8 sm:py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium text-sm sm:text-base">
                  Start Practice
                </button>
                <button className="px-6 py-2.5 sm:px-8 sm:py-3 border border-purple-200 text-purple-700 rounded-lg hover:bg-purple-50 transition-colors font-medium text-sm sm:text-base">
                  Customize Session
                </button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-4 text-center">
                <div className="p-2 sm:p-3 bg-white rounded-lg">
                  <div className="font-semibold text-purple-600 text-sm sm:text-base">42</div>
                  <div className="text-xs sm:text-sm text-gray-600">
                    Sessions
                  </div>
                </div>
                <div className="p-2 sm:p-3 bg-white rounded-lg">
                  <div className="font-semibold text-pink-600 text-sm sm:text-base">7</div>
                  <div className="text-xs sm:text-sm text-gray-600">Day streak</div>
                </div>
                <div className="p-2 sm:p-3 bg-white rounded-lg">
                  <div className="font-semibold text-orange-600 text-sm sm:text-base">156</div>
                  <div className="text-xs sm:text-sm text-gray-600">
                    Affirmations
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8 mb-6 sm:mb-8 transform transition-all hover:shadow-xl border-t-4 border-rose-400">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 italic border-l-4 border-rose-200 pl-3 py-1">
                ...
                >
                  <div className="relative h-24 sm:h-32">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                      ...
                      <span className="text-xs sm:text-sm font-medium">{mood.mood}</span>
                    </div>
                  </div>
                  <div className="p-2 sm:p-3 bg-white border-t border-gray-100">
                    <p className="text-xs text-center">{mood.count}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="p-4 bg-gradient-to-r from-rose-50 to-pink-50 rounded-lg border border-rose-100">
              ...
              <button className="w-full sm:w-auto px-4 py-2 sm:px-6 sm:py-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-lg hover:from-rose-600 hover:to-pink-600 transition-all shadow-md hover:shadow-lg text-xs sm:text-sm font-medium flex items-center justify-center gap-2 mx-auto">
          ...
          <div className="rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8 mb-6 sm:mb-8 text-white relative overflow-hidden bg-cover bg-center bg-blend-overlay bg-black/40 morning-ritual-bg">
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-4 sm:mb-6">
                <Sunrise className="w-5 h-5 sm:w-6 sm:h-6" />
                <h2 className="text-lg sm:text-xl font-semibold">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
                <div className="backdrop-blur-sm bg-white/10 p-4 sm:p-6 rounded-lg border border-white/20">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <Sunrise className="w-5 h-5 sm:w-6 sm:h-6" />
                    <h3 className="text-base sm:text-lg font-semibold">Morning Awakening</h3>
                  </div>
                  ...
                  <button className="w-full sm:w-auto px-3 py-1.5 sm:px-4 sm:py-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg hover:bg-white/30 transition-colors text-xs sm:text-sm font-medium">
                    Start Morning Practice
                  </button>
                </div>
                <div className="backdrop-blur-sm bg-white/10 p-4 sm:p-6 rounded-lg border border-white/20 mt-4 md:mt-0">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8 mb-6 sm:mb-8">
            <div className="flex items-center gap-2 mb-4 sm:mb-6">
              <Camera className="w-4 h-4 sm:w-5 sm:h-5 text-purple-500" />
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900">
                Visual Affirmation Gallery
              </h2>
            </div>
                ...
                >
                  <div className="relative h-40 sm:h-48">
                    ...
                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <div className="text-center text-white p-4">
                        <button className="px-3 py-1.5 sm:px-4 sm:py-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg hover:bg-white/30 transition-colors text-xs sm:text-sm font-medium mb-2">
                          <Play className="w-3 h-3 sm:w-4 sm:h-4 inline mr-1" />
                          Listen
                        </button>
                        <div>
                          <button className="px-2 py-0.5 sm:px-3 sm:py-1 bg-white/20 backdrop-blur-sm border border-white/30 rounded text-xs hover:bg-white/30 transition-colors mr-2">
                            Share
                          </button>
                          <button className="px-2 py-0.5 sm:px-3 sm:py-1 bg-white/20 backdrop-blur-sm border border-white/30 rounded text-xs hover:bg-white/30 transition-colors">
                            Save
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="p-3 sm:p-4 bg-white">
                    <div className="flex items-center gap-2 mb-2">
                      <span
                        className={`px-2 py-0.5 sm:py-1 ${item.color} text-white text-xs rounded-full`}
                      >
                        {item.category}
                      </span>
                    </div>
            ...
            <div className="mt-5 sm:mt-6 text-center">
              <button className="w-full sm:w-auto px-4 py-2 sm:px-6 sm:py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium text-sm sm:text-base">
          ...
          <div className="rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8 mb-6 sm:mb-8 text-white relative overflow-hidden bg-cover bg-center bg-blend-overlay bg-black/40 audio-bg">
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-4 sm:mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                <div className="backdrop-blur-sm bg-white/10 p-4 sm:p-6 rounded-lg border border-white/20">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold">Guided Sessions</h3>
                  </div>
                  ...
                  <button className="w-full py-1.5 sm:py-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg hover:bg-white/30 transition-colors text-xs sm:text-sm font-medium">
                    Browse All Sessions
                  </button>
                </div>

                <div className="backdrop-blur-sm bg-white/10 p-4 sm:p-6 rounded-lg border border-white/20 mt-4 sm:mt-0">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <Sparkles className="w-5 h-5 sm:w-6 sm:h-6" />
                    <h3 className="text-base sm:text-lg font-semibold">Nature Sounds</h3>
                  </div>
                  <p className="text-white/90 text-xs sm:text-sm mb-3 sm:mb-4">
                ...
                <div className="backdrop-blur-sm bg-white/10 p-4 sm:p-6 rounded-lg border border-white/20 mt-4 md:mt-0">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold">Binaural Beats</h3>
                  </div>
                  <p className="text-white/90 text-xs sm:text-sm mb-3 sm:mb-4">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8 mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-8 mb-5 sm:mb-6">
              <div className="p-4 sm:p-6 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg border border-emerald-100">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-emerald-600">Day 12 of 30</p>
                  </div>
                </div>
                ...
                <button className="w-full sm:w-auto px-3 py-1.5 sm:px-4 sm:py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-xs sm:text-sm font-medium">
                  Continue Challenge
                </button>
              </div>
              ...
              <div className="p-4 sm:p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-100">
                ...
                <button className="w-full sm:w-auto px-3 py-1.5 sm:px-4 sm:py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-xs sm:text-sm font-medium">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
              <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
                <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 rounded-lg overflow-hidden">
                  <Image
                ...
                <div className="font-semibold text-emerald-600 text-base sm:text-lg">14</div>
                <div className="text-xxs sm:text-xs text-gray-600">Day Streak</div>
              </div>
              <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
                <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 rounded-lg overflow-hidden">
                  <Image
                ...
                <div className="font-semibold text-blue-600 text-base sm:text-lg">89</div>
                <div className="text-xxs sm:text-xs text-gray-600">Total Sessions</div>
              </div>
              <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
                <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 rounded-lg overflow-hidden">
                  <Image
                ...
                <div className="font-semibold text-purple-600 text-base sm:text-lg">267</div>
                <div className="text-xxs sm:text-xs text-gray-600">Minutes Practiced</div>
              </div>
              <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
                <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 rounded-lg overflow-hidden">
                  <Image
                ...
                <div className="font-semibold text-pink-600 text-base sm:text-lg">23</div>
                <div className="text-xxs sm:text-xs text-gray-600">Favorites Saved</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8 mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-5 sm:mb-6">
              {[
                {
                ...
                <div key={index} className="group">
                  <div className="relative mb-3 sm:mb-4 rounded-lg overflow-hidden shadow-md">
                    ...
                    <div className="absolute top-2 left-2">
                      <span
                        className={`px-2 py-0.5 sm:py-1 ${resource.color} text-white text-xs rounded-full`}
                      >
                        {resource.type}
                      </span>
                    </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                    <button className="w-full sm:w-auto px-3 py-1.5 sm:px-4 sm:py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors text-xs sm:text-sm font-medium">
                      Enroll Now
                    </button>
                    <button className="w-full sm:w-auto px-3 py-1.5 sm:px-4 sm:py-2 border border-indigo-300 text-indigo-600 rounded-lg hover:bg-indigo-50 transition-colors text-xs sm:text-sm font-medium">
                      Learn More
                    </button>
                  </div>
                </div>
          ...
          {/* Community & Sharing */}
          <div className="rounded-xl sm:rounded-2xl shadow-lg p-5 sm:p-8 mb-6 sm:mb-8 text-white relative overflow-hidden bg-cover bg-center bg-blend-overlay bg-black/40 community-bg">
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-4 sm:mb-6">
                <Heart className="w-5 h-5 sm:w-6 sm:h-6" />
                <h2 className="text-lg sm:text-xl font-semibold">Community & Sharing</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
                <div>
                  ...
                  <div className="space-y-3 mb-4 sm:mb-6">
                    <div className="backdrop-blur-sm bg-white/10 p-3 sm:p-4 rounded-lg border border-white/20">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full flex items-center justify-center text-xs sm:text-sm font-semibold">
                          S
                        </div>
                        <div>
                          <h4 className="font-medium text-xs sm:text-sm">Sarah M.</h4>
                          <p className="text-white/80 text-xxs sm:text-xs">2 hours ago</p>
                        </div>
                      </div>
                    ...
                    <div className="backdrop-blur-sm bg-white/10 p-3 sm:p-4 rounded-lg border border-white/20">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-r from-blue-400 to-teal-400 rounded-full flex items-center justify-center text-xs sm:text-sm font-semibold">
                          M
                        </div>
                        <div>
                          <h4 className="font-medium text-xs sm:text-sm">Marcus T.</h4>
                          <p className="text-white/80 text-xxs sm:text-xs">5 hours ago</p>
                        </div>
                      </div>
                      <p className="text-white/90 text-xs sm:text-sm">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="backdrop-blur-sm bg-white/10 p-3 sm:p-4 rounded-lg border border-white/20">
                      <div className="flex items-center gap-2 sm:gap-3 mb-2">
                        ...
                        <h4 className="font-medium text-xs sm:text-sm">30-Day Transformation</h4>
                      </div>
                      ...
                      <button className="text-xs sm:text-sm text-yellow-300 hover:text-yellow-200 transition-colors">
                        Read Full Story →
                      </button>
                    </div>
                    <div className="backdrop-blur-sm bg-white/10 p-3 sm:p-4 rounded-lg border border-white/20">
                      <div className="flex items-center gap-2 sm:gap-3 mb-2">
                        ...
                        <h4 className="font-medium text-xs sm:text-sm">Healing Through Words</h4>
                      </div>
                      <p className="text-white/80 text-xs sm:text-sm mb-2 sm:mb-3">
                        &ldquo;How affirmations helped me overcome anxiety and
                        find inner peace&rdquo;
                      </p>
                      <button className="text-xs sm:text-sm text-pink-300 hover:text-pink-200 transition-colors">
                        Read Full Story →
                      </button>
                    </div>
                    <div className="backdrop-blur-sm bg-white/10 p-3 sm:p-4 rounded-lg border border-white/20">
                      <div className="flex items-center gap-2 sm:gap-3 mb-2">
                        ...
                        <h4 className="font-medium text-xs sm:text-sm">Building Confidence</h4>
                      </div>
                      <p className="text-white/80 text-xs sm:text-sm mb-2 sm:mb-3">
                        &ldquo;From workplace anxiety to leadership confidence
                        with daily affirmations&rdquo;
                      </p>
                      <button className="text-xs sm:text-sm text-red-300 hover:text-red-200 transition-colors">
                        Read Full Story →
                      </button>
                    </div>
                  </div>
                ...
                >
                  <div className="relative h-28 sm:h-36">
                    ...
                    <div className="absolute bottom-0 left-0 p-3 sm:p-4 text-white">
                      <h3 className="font-semibold text-sm sm:text-lg">{section.title}</h3>
                    </div>
                  </div>
                  <div className="p-3 sm:p-5 flex flex-col flex-grow">
                    ...
                    <div className="mb-4 sm:mb-5 flex-grow">
                      <ul className="space-y-1.5 sm:space-y-2">
                        {section.tips.map((tip, tipIndex) => (
                          <li
                            key={tipIndex}
                            className="text-xs sm:text-sm flex items-center gap-2 text-gray-600"
                          >
                            <div
                              className={
                    ...
                    <button
                      className={
                        section.colorClass === "amber"
                          ? "w-full px-3 py-2 sm:px-4 sm:py-3 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors font-medium text-xs sm:text-sm"
                          : section.colorClass === "blue"
                          ? "w-full px-3 py-2 sm:px-4 sm:py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors font-medium text-xs sm:text-sm"
                          : section.colorClass === "rose"
                          ? "w-full px-3 py-2 sm:px-4 sm:py-3 bg-rose-500 text-white rounded-lg hover:bg-rose-600 transition-colors font-medium text-xs sm:text-sm"
                          : "w-full px-3 py-2 sm:px-4 sm:py-3 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition-colors font-medium text-xs sm:text-sm"
                      }
                    >
                      Get Tips
                    </button>
          ...
          {/* Footer Section */}
          <section className="py-6 sm:py-8 bg-white border-t border-gray-100 mt-12 sm:mt-16">
            <div className="container mx-auto px-4">
              <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center gap-5 sm:gap-6">
                  <div className="flex flex-col items-center md:items-start">
                    <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent mb-2">
                      MirianiWell
                    </h3>
                  ...
                  <div className="flex gap-6 sm:gap-8 md:gap-16 mt-4 md:mt-0">
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2 sm:mb-3 text-sm sm:text-base text-center md:text-left">
                        Resources
                      </h4>
                      <div className="flex flex-col gap-2">
                        <Link
                          href="/journal"
                          className="text-slate-600 hover:text-pink-600 text-xs sm:text-sm flex items-center gap-2 transition-all hover:translate-x-1"
                        >
