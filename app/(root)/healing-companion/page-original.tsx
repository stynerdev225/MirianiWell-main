    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 p-6 relative">
      ...
      <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto">
        ...
        <div className="flex-1">
          ...
          <div className="rounded-2xl shadow-lg p-8 mb-6 text-white relative overflow-hidden bg-cover bg-center healing-sessions-bg">
          ...
          {/* Resources & Learning */}
          <div className="rounded-2xl shadow-lg p-8 mb-6 text-white relative overflow-hidden bg-cover bg-center resources-learning-bg">
