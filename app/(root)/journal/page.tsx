...
import { getJournalEntriesByUserId } from "@/lib/actions/general.action";
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 transform transition-transform hover:scale-[1.01]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              {[
                ...
                "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=300&h=300&fit=crop&crop=center",
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              {[
                ...
                },
                {
                  ...
                  description: "Mixed emotions, mostly positive",
                },
                {
                  emoji: "🌧️",
                  mood: "Rainy",
                  ...
                  image:
                    "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=300&h=200&fit=crop&crop=center",
                ...
                },
                {
                  ...
                  image:
                    "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=300&h=200&fit=crop&crop=center",
                  description: "Overwhelmed or stressed",
                },
              ].map((mood, index) => (
                <div
                  key={index}
              ...
              {[
                {
                  ...
                  description: "Combine drawings with words",
                  color: "bg-purple-500",
                },
                {
                  title: "Poetry Corner",
                  image:
                    "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=300&h=300&fit=crop&crop=center",
                  description: "Express feelings through verse",
                  color: "bg-pink-500",
                },
                {
                  title: "Photo Stories",
                ...
                },
                {
                  title: "Voice Notes",
                  image:
                    "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=300&h=300&fit=crop&crop=center",
                  description: "Record audio reflections",
                  color: "bg-green-500",
                },
              ].map((item, index) => (
                <div
              ...
              {[
                {
                  ...
                  description:
                    "A spiritual path to higher creativity through morning pages",
                  category: "Creativity",
                },
                {
                  title: "Bird by Bird",
                  ...
                  description:
                    "Instructions on writing and life with wisdom and humor",
                  category: "Writing",
                },
                {
                  ...
                  description: "Embrace vulnerability and cultivate courage",
