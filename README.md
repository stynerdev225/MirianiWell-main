<div align="center">
  ...
  <div>
    ...
    <img src="https://img.shields.io/badge/-Cloudflare-black?style=for-the-badge&logoColor=white&logo=cloudflare&color=F38020" alt="cloudflare" />
    <img src="https://img.shields.io/badge/-Clerk-black?style=for-the-badge&logoColor=white&logo=clerk&color=6C47FF" alt="clerk" />
  </div>

  <h3 align="center">Mirani Well: A holistic wellness and healing platform powered by AI-guided practices</h3>

   <div align="center">
     Experience elemental rituals, emotional support, and personalized healing journeys through AI-powered guidance and mindful practices.
    </div>
</div>
...
Built with Next.js for the user interface and backend logic, Clerk for authentication and Cloudflare D1 for data storage, styled with TailwindCSS and using AI-powered healing guidance, Mirani Well is a wellness platform designed to support your emotional wellbeing and spiritual growth. The platform offers a serene and healing experience through elemental rituals, mood tracking, journaling, and personalized affirmations.
...
👉 **Authentication**: Sign Up and Sign In using password/email authentication handled by Clerk.

👉 **Elemental Rituals**: Experience guided practices through Earth, Water, Fire, and Air elements for holistic healing.

👉 **AI Healing Companion**: Receive personalized emotional support and healing guidance powered by AI.

👉 **Modern UI/UX**: A serene and calming interface designed for wellness and mindfulness.

👉 **Mood Tracking**: Daily check-ins and emotional wellness monitoring with insightful analytics.

👉 **Affirmation Library**: Browse and practice with curated affirmations for different life areas and moods.

👉 **Journaling**: Sacred space for reflection, gratitude, and personal growth through guided prompts.
...
Replace the placeholder values with your actual **[Clerk](https://clerk.com/)**, **[Cloudflare](https://cloudflare.com/)**, and **[Vapi](https://vapi.ai/?utm_source=youtube&utm_medium=video&utm_campaign=jsmastery_recruitingpractice&utm_content=paid_partner&utm_term=recruitingpractice)** credentials.
